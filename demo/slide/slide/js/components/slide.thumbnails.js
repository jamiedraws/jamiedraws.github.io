Slide.proto.makeThumbnail = function(element, id) {
...
Slide.proto.addThumbnail = function(thumbnail) {
	if (this.thumbnails) {
		this.thumbnails.appendChild(thumbnail);
	}
};

Slide.proto.selectThumbnail = function(id) {
...
Slide.proto.addThumbnailImage = function(img) {
